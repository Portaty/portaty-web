...
export default function CustomerShopCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new CustomerShop(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CustomerShopCreateForm")}
      {...rest}
    >
      <TextField
        label="User id"
