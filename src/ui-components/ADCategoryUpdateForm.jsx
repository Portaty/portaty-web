...
export default function ADCategoryUpdateForm(props) {
  const {
    id: idProp,
    aDCategory: aDCategoryModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = aDCategoryRecord
      ? { ...initialValues, ...aDCategoryRecord }
      : initialValues;
  ...
  const [aDCategoryRecord, setADCategoryRecord] =
    React.useState(aDCategoryModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(ADCategory, idProp)
        : aDCategoryModelProp;
      setADCategoryRecord(record);
    };
    queryData();
  }, [idProp, aDCategoryModelProp]);
  React.useEffect(resetStateValues, [aDCategoryRecord]);
  const validations = {
    name: [{ type: "Required" }],
    image: [],
    path: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            ADCategory.copyOf(aDCategoryRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "ADCategoryUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || aDCategoryModelProp)}
