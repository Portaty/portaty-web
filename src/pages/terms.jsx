  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Country</strong> refers to: Colombia
          </p>
        </li>
        <li>
          <p>
            ...
            this Agreement) refers to Portaty C.A, calle 152a #101a - 45.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Portaty, accessible from{" "}
            <a
              href="https://www.portaty.com"
      ...
      <ul>
        <li>By email: soporte@portaty.com</li>
      </ul>
    </div>
  );
};
