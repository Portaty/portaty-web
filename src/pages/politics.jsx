...
const PrivacyPolicy = () => {
  return (
    <div>
      ...
      <p>Última actualización: 17 de enero de 2024</p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Portaty, the software program
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Portaty C.A, calle 152a
            #101a-45.
          </p>
        </li>
        <li>
